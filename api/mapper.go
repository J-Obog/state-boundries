...
var mapper = map[string]Location{
	...
	"SD": {"South Dakota", "SD", []string{"ND", "MN", "IA", "NE", "WY", "MT"}},
	"TN": {"Tennessee", "TN", []string{"KY", "VA", "NC", "GA", "AL", "MS", "AR", "MO"}},
	"TX": {"Texas", "TX", []string{"LA", "AR", "OK", "NM"}},
	"UT": {"Utah", "UT", []string{"ID", "WY", "NV", "CO", "NM", "AZ"}},
	"VT": {"Vermont", "VT", []string{"NH", "MA", "NY"}},
	"VA": {"Virginia", "VA", []string{"MD", "NC", "TN", "KY", "WV"}},
	"WA": {"Washington", "WA", []string{"ID", "OR"}},
	"WV": {"West Virginia", "WV", []string{"PA", "MD", "VA", "KY", "OH"}},
	"WI": {"Wisconsin", "WI", []string{"IL", "IA", "MN", "MI"}},
	"WY": {"Wyoming", "WY", []string{"MT", "SD", "NE", "CO", "UT", "ID"}},
}
